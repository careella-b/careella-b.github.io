                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="intro__content">
                                <p className="text-center intro-text">Our demands seek to change the terms and conditions of conversations about race and racism.</p>
                                <h3 className="text-center intro-title">Scrap the Police Crimes and Sentencing Bill</h3>
                                <p className="intro-text">(see https://bills.parliament.uk/bills/2839 or https://www.gov.uk/government/publications/police-crime-sentencing-and-courts-bill-2021-factsheets/police-crime-sentencing-and-courts-bill-2021-protest-powers-factsheet   for information about this bill).</p>
                                <p className="intro-text">We must defend our right to protest, but we also recognise that this bill could have a disproportionately harmful impact on people vulnerable to police violence.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="slider__area missionBg">
                <div className="container intro-container">
                    <div className="row">
                        <div className="col-12">
                            <div className="intro__content">
                                <h3 className="text-center blog-title">Scrap the Nationality and Borders Bill</h3>
            ...
            <section className="slider__area intro-bg-colour">
                <div className="container intro-container">
                    <div className="row">
                        <div className="col-12">
                            <div className="intro__content">
                                <h3 className="text-center intro-title">Decolonise Education</h3>
                                <p className="intro-text">Educational institutions must decolonise education. Teach histories not history. Teach about colonisation and decolonisation. Teach critical race theory. Teach intersectionality. Teach people how to have healthy and safe conversations about race and racism with respect for one another. This should be compulsory in the same way that sex education is compulsory.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="slider__area missionBg">
                <div className="container intro-container">
                    <div className="row">
                        <div className="col-12">
                            <div className="intro__content">
                                <h3 className="text-center blog-title">Genuine Equality, Diversity, and Inclusion</h3>
            ...
            <section className="slider__area missionBg">
                <div className="container intro-container">
                    <div className="row">
                        <div className="col-12">
                            <div className="intro__content">
                                <h3 className="text-center blog-title">Institutions, Organisations, Groups, and Individuals, need to be held accountable</h3>
